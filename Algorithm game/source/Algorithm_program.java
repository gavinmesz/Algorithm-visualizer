...
public class Algorithm_program extends PApplet {
...
class wall { //player collides into the wall and can't go through. seen on main page and sorting pages
  ...
  public void render() { //guzy COLLISIONS
    fill(0);
    stroke(255);
...
class sortbloc { //blocks that move in the sorting algorithms. Carries value and position
  ...
  public void home() { //targets a spot and moves to it.
...
public ArrayList<sortbloc> randosort(ArrayList<sortbloc> x) {
...
class button {
  ...
  public boolean isOn() { //checks if the mosue is on the button.
    boolean bruh=false;
...
public void setup() { //initializing everything
...
public void selsort() { //Selection sort.
...
public void keyReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#FF0000", "Algorithm_program" };
    if (passedArgs != null) {
